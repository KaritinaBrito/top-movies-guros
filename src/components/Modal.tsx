...
export const Modal = ({genres, title, description, vote_average, id, poster, handleShowModal}:ModalProps) => {
    ...
    return(
        <main className="fixed gap-10 inset-0 bg-guros-gray950 bg-opacity-80 lg:mb-2" onClick={handleShowModal}>
            <section className="bg-guros-white w-full absolute bottom-0 h-3/4 lg:flex lg:gap-10" onClick={(e) => e.stopPropagation()}>
                ...
                <section className="px-2 flex flex-col lg:w-full pb-2 justify-around">
                    <div>
